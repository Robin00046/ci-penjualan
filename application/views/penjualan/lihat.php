											...
											<tr>
												...
												if ($this->session->login['role'] == 'admin') {
													if ($penjualan->status == 0) {
														echo '<td><a href="' . base_url('penjualan/konfirmasi/' . $penjualan->no_penjualan) . '" class="btn btn-success btn-sm"><i class="fa fa-check"></i><br>Konfirmasi</a></td>';
													} else {
														echo '<td><a href="' . base_url('penjualan/batal_konfirmasi/' . $penjualan->no_penjualan) . '" class="btn btn-danger btn-sm"><i class="fa fa-times"></i><br>Batal Konfirmasi</a></td>';
													}
												} else {

													if ($penjualan->status == 0) {
														echo '<td><span class="badge badge-danger">Belum Dikonfirmasi</span></td>';
													} else {
														echo '<td><span class="badge badge-success">Sudah Dikonfirmasi</span></td>';
													}
												}
												?>
												<td>
